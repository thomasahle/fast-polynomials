...
\begin{tikzpicture}[x=1cm,y=1cm,>=Latex]
  ...
  \node[fp recursive, minimum width=36mm, anchor=west] (l15) at (8.5,5.02)
  ...
  \node[fp label, anchor=west, text=fpBlue!80!black] at (0,-0.03)
    {At every red seam, subtract the displayed fixed leading coefficient before taking the next monic root.};
\end{tikzpicture}
