...
\begin{tikzpicture}[x=1cm,y=1cm,>=Latex]
  ...
  \node[fp second, minimum width=8mm, minimum height=4mm] at (3.6,0.2) {};
  \node[fp label, anchor=west] at (4.1,0.2) {next block};
  \node[fp recursive, minimum width=8mm, minimum height=4mm] at (6.35,0.2) {};
  \node[fp label, anchor=west] at (6.85,0.2) {smaller instance};
  \node[fp pivot, minimum width=8mm, minimum height=4mm] at (9.85,0.2) {};
  \node[fp label, anchor=west] at (10.35,0.2) {constant-slope pivot};
  \node[fp known, minimum width=8mm, minimum height=4mm] at (0.4,-0.45) {};
  \node[fp label, anchor=west] at (0.9,-0.45) {known};
  \node[fp unread, minimum width=8mm, minimum height=4mm] at (3.6,-0.45) {};
  \node[fp label, anchor=west] at (4.1,-0.45) {not yet read};
  \node[fp seam, minimum width=8mm, minimum height=4mm] at (6.35,-0.45) {};
  \node[fp label, anchor=west] at (6.85,-0.45) {boundary seam};
\end{tikzpicture}
