...
explicit finite examples and a formal lower bound, but a uniform all-degree
analogue of the upper bound remains open. See the characteristic-two examples in
...
- `FastPoly.lean`, `FastPoly/` — the Lean 4 formalization.
