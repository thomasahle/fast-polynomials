...
/-!
# The existing degree-23 circuit: twelve literal multiplications

Each gate, bind tail and semantic environment has a name. The bridge
follows the twelve displayed products and never expands their composite
polynomial. This is the fixed counted program for the supplied decoder.
-/

namespace FastPoly.Char2Degree23Program

open Polynomial Char2Certificate Char2Degree23RowEight
set_option maxHeartbeats 20000

variable {F : Type*} [Field F] [CharP F 2]

noncomputable def m (a : ℕ → F) : F[X] :=
  crownLeft a * (crownRight a + C (a 19))
noncomputable def n (a : ℕ → F) : F[X] :=
  lastFactor a * (u a + m a + C (a 21))

theorem output_eq (a : ℕ → F) : output a = head a + n a + C (a 22) := rfl
...
def gate3 : Cost.Circuit F (Inputs 3) 1 :=
  .mul (.add (.add (.add (.input (Sum.inl (Sum.inl (Sum.inr 0)))) (.input (Sum.inl (Sum.inr 0)))) (.input (Sum.inr 0))) (.input (Sum.inl (Sum.inl (Sum.inl (5)))))) (.add (.add (.input (Sum.inl (Sum.inr 0))) (.input (Sum.inr 0))) (.input (Sum.inl (Sum.inl (Sum.inl (6))))))

def gate4 : Cost.Circuit F (Inputs 4) 1 :=
  .mul (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0)))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (7))))))) (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))) (.input (Sum.inl (Sum.inl (Sum.inr 0))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (8)))))))
...
def gate7 : Cost.Circuit F (Inputs 7) 1 :=
  .mul (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (13)))))))))) (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (14))))))))))

def gate8 : Cost.Circuit F (Inputs 8) 1 :=
  .mul (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (15))))))))))) (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0)))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (16)))))))))))

def gate9 : Cost.Circuit F (Inputs 9) 1 :=
  .mul (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (17)))))))))))) (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (18))))))))))))

def gate10 : Cost.Circuit F (Inputs 10) 1 :=
  .mul (.add (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0)))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (19))))))))))))) (.add (.add (.add (.add (.add (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (0)))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))) (.input (Sum.inl (Sum.inr 0)))) (.input (Sum.inr 0))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (20)))))))))))))

def gate11 : Cost.Circuit F (Inputs 11) 1 :=
  .mul (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (21)))))))))))))) (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))) (.input (Sum.inr 0))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (22))))))))))))))

def tail12 : Cost.Circuit F (Inputs 12) 1 :=
  (.add (.add (.add (.add (.add (.add (.add (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0))))))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inr 0)))))) (.input (Sum.inr 0))) (.input (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (Sum.inl (23)))))))))))))))
...
theorem multiplication_count : (circuit (F := F)).gates.multiplications = 12 := by
  simp only [circuit, tail0, tail1, tail2, tail3, tail4, tail5, tail6, tail7, tail8, tail9, tail10, tail11, tail12,
...
def program : Cost.MultiplicationProgram F ℕ 1 12 :=
...
theorem gate8_eval (a : ℕ → F) (i : Fin 1) :
    (gate8 (F := F)).eval (env8 a) i = g a := by
...
theorem gate9_eval (a : ℕ → F) (i : Fin 1) :
    (gate9 (F := F)).eval (env9 a) i = ell a := by
...
theorem gate10_eval (a : ℕ → F) (i : Fin 1) :
    (gate10 (F := F)).eval (env10 a) i = m a := by
  simp only [gate10, Cost.Circuit.eval, Cost.Circuit.input,
    ...
    inputEnv, Nat.reduceSub, OfNat.ofNat_ne_zero, one_ne_zero, ite_false, ite_true,
    m, crownLeft, crownRight, add_assoc]

theorem gate11_eval (a : ℕ → F) (i : Fin 1) :
    (gate11 (F := F)).eval (env11 a) i = n a := by
  simp only [gate11, Cost.Circuit.eval, Cost.Circuit.input,
    env11, env10, env9, env8, env7, env6, env5, env4, env3, env2, env1, env0, Sum.elim_inl, Sum.elim_inr,
    inputEnv, Nat.reduceSub, OfNat.ofNat_ne_zero, one_ne_zero, ite_false, ite_true,
    n, lastFactor, add_assoc]

theorem tail12_eval (a : ℕ → F) :
    (tail12 (F := F)).eval (env12 a) 0 = output a := by
  simp only [tail12, Cost.Circuit.eval, Cost.Circuit.input,
    env12, env11, env10, env9, env8, env7, env6, env5, env4, env3, env2, env1, env0,
    Sum.elim_inl, Sum.elim_inr, inputEnv, Nat.reduceSub,
    OfNat.ofNat_ne_zero, one_ne_zero, ite_false, ite_true, output_eq, head, add_assoc]

theorem tail11_eval (a : ℕ → F) :
    (tail11 (F := F)).eval (env11 a) 0 = output a := by
  have hg : (gate11 (F := F)).eval (env11 a) = (fun _ => n a) :=
    funext (gate11_eval a)
  rw [tail11, Cost.Circuit.eval, hg]
  exact tail12_eval a

theorem tail10_eval (a : ℕ → F) :
    (tail10 (F := F)).eval (env10 a) 0 = output a := by
  have hg : (gate10 (F := F)).eval (env10 a) = (fun _ => m a) :=
...
theorem tail9_eval (a : ℕ → F) :
  ...
  have hg : (gate9 (F := F)).eval (env9 a) = (fun _ => ell a) :=
    funext (gate9_eval a)
...
theorem tail8_eval (a : ℕ → F) :
  ...
  have hg : (gate8 (F := F)).eval (env8 a) = (fun _ => g a) :=
    funext (gate8_eval a)
...
end FastPoly.Char2Degree23Program
