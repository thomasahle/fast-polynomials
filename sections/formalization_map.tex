...
\end{tabular}\par
\noindent\begin{tabular}{p{0.95in}p{2.05in}p{1.75in}p{0.55in}}
\raggedright Website characteristic-two constructions (degrees $5$--$16$) &\raggedright
...
commit \texttt{4be4943}; the umbrella is being refactored and a tagged commit
will be named in the final version. No file under \texttt{FastPoly/\allowbreak } declares an \texttt{axiom} or
