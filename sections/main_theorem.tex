...
(\Cref{thm:construction-height-peeled}).
\end{theorem}
...
some pivots may vanish.  A complete \emph{single-circuit} construction with
...
For the height claim of \Cref{thm:main}, the known-powers gadgets are instead scheduled as a balanced two-child recursion with a keyed glue factor (the peeled gadget of \Cref{sec:peeled-Q}), at the identical gate ledger; the sequential fill remains the baseline used for the addition accounting.
...
\begin{itemize}
  ...
  height at most $2\lceil\log_2k\rceil+5$, \Cref{thm:construction-height-peeled}
