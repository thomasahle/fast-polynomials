...
Motzkin's quartic needs $2u_4$ invertible and Pan's sextic $6u_6$
together with the denominator of its
preprocessing~\cite[p.~494]{knuth1997seminumerical}; Belaga's normalisation
...
each rung is one product, $H_{2^{i+1}}=H_{2^i}^2+\text{lower terms}$, built by the $T$ recursion of
\Cref{sec:splittable-4k+1} and spelled out at the start of \Cref{sec:peeled-Q}),
