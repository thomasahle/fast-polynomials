...
\begin{itemize}
    ...
    \item \textbf{x86}: Intel Xeon Platinum 8375C (Ice Lake, x86-64) running Linux, using Intel intrinsics
          ...
          One x86 result is from a different host: the prime-field kernels
          of \Cref{sec:experiments:crypto} report the run on an AMD EPYC
...
8375C; AMD EPYC 9R14 for the prime-field kernels, as noted above).
