...
\begin{itemize}
    ...
    \item \textbf{Lemire}: Horner's rule using Lemire's fast modular reduction~\cite[\S4.4]{lemire2015clhash},
...
back ends.  In SMHasher3's own bulk benchmark they run at $22.2$ and $17.3$
bytes per cycle on the M2 Pro ($15.4$ and $12.3$ on the Xeon) and hash
$1$--$31$-byte keys in $72$ and $77$ cycles ($108$ and $109$ on the Xeon).
