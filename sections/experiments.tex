...
\end{tabular}
\end{center}
The three quartic rows are the implementations \texttt{quartic2\_64},
\texttt{quartic3\_64} and \texttt{motzkin\_61} of \Cref{tab:families};
the \texttt{mult4} of Table~\ref{tab:kwise_both} is the first of these on
ARM and the second on x86.  The $k=7$ row times the certified degree-$7$
