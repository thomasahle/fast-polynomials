...
ARM and the second on x86.  The $k=7$ row times the search circuit
\texttt{mult7} of \Cref{tab:families}, for which no inverse is displayed: it
has seven keys, but no independence is claimed for it.
