...
$\lfloor5/2\rfloor+1$ as in \Cref{thm:main} (\texttt{chain<5>} in
\texttt{chainhash.h}, where the intermediates are called \texttt{y},
\texttt{z}, \texttt{t}).  It is monic of degree $5$ (\Cref{lem:ph:chain}).
...
timing noise.  Degree $5$ with the input twist is therefore $15\%$ faster
